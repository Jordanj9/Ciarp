...
<ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
    ...
    <li class="active"><a href="{{route('ponencia.indexadmin')}}">Ponencias</a></li>
...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                    GESTIÓN DE PONENCIA - EVALUAR PRODUCTIVIDAD
                </h2>
            </div>
            <div class="body">
                    ...
                    <div class="col-md-12">
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr class="read">
                                    <td class="contact"><b>Pagina Web</b></td>
                                    <td class="subject">{{$ponencia->paginaweb}}</td>
                                </tr>
                                <tr class="read">
                ...
                <h1 class="card-inside-title">EVALUAR PONENCIA: {{$solicitud->titulo}}</h1>
                <div class="row clearfix">
                    <div class="col-md-12">
                        {!! Form::open(['route'=>'ponencia.calificar','method'=>'POST','class'=>'form-horizontal','files'=>'true'])!!}
                        <div class="col-md-12">
                            <input type="hidden" name="ponencia_id" value="{{$ponencia->id}}" />
                            ...
                            <div class="form-group">
                                <br/><br/><a href="{{route('ponencia.indexadmin')}}" class="btn bg-red waves-effect">Cancelar</a>
