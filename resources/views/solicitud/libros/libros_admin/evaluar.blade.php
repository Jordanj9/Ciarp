...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                    GESTIÓN DE LIBRO - EVALUAR PRODUCTIVIDAD
                </h2>
            </div>
            <div class="body">
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr class="read">
                                    ...
                                    <td class="subject">
                                        @if($libro->tipo == 'LT')LIBRO DE TEXTO
                ...
                <h1 class="card-inside-title">EVALUAR LIBRO: {{$solicitud->titulo}}</h1>
                <div class="row clearfix">
                    <div class="col-md-12">
                        {!! Form::open(['route'=>'libro.calificar','method'=>'POST','class'=>'form-horizontal','files'=>'true'])!!}
                        <div class="col-md-12">
