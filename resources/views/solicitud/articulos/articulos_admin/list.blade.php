        ...
        <div class="card">
            ...
            <div class="body">
                <div class="alert bg-green alert-dismissible" role="alert">
                    ...
                    <strong>Detalles: </strong>Gestione las productividad académica de tipo Artículos científicos realizadas por los docentes </div>
                    ...
                    <table id="tabla" class="table table-bordered table-striped table-hover table-responsive table-condensed" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('articulo.evaluar',$d->id)}}" class="btn bg-indigo waves-effect btn-xs" data-toggle="tooltip" data-placement="top" title="Evaluar Solicitud"><i class="material-icons">check_circle</i></a>
